...
2. `plan_feature`: create only a concrete three-to-seven-step plan.
3. `ambiguous_architecture`: ask one round of at most two material questions and make no edits.
4. `execute_plan`: execute the approved plan, update its step checkboxes, and pass tests.
